...
app.directive("guardarTempo",function(){
	
	return{

		restrict:"AE",
		templateUrl:"/ProjetoLoja/views/venda/guardarTempo.html"
...
app.directive("tempoOffline",function(){
	
	return{

		restrict:"AE",
		templateUrl:"/ProjetoLoja/views/venda/tempoOffline.html"
