app.factory('produtosAPI', function ($http) {
	...
	var _editControleProduto = function(objectId,produtosControle){
		return $http.put('https://api.backendless.com/v1/data/ControleProduto/'+objectId,produtosControle,{
	...
	var _deleteControleProduto = function(objectId){
		return $http.delete('https://api.backendless.com/v1/data/ControleProduto/'+objectId,{
	...
	return {
		...
		editControleProduto:_editControleProduto,
		deleteControleProduto: _deleteControleProduto
	};
})