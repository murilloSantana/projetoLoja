app.factory('vendasAPI', function ($http) {
	...
	var _deleteGuardarTempo = function(objectId){
		return $http.delete('https://api.backendless.com/v1/data/GuardarTempo/'+objectId,{
	...
	var _deleteVenda = function(objectId){
		return $http.delete('https://api.backendless.com/v1/data/Vendas/'+objectId,{
	...
	return {
		...
		deleteGuardarTempo: _deleteGuardarTempo,
		deleteVenda: _deleteVenda
	};
})